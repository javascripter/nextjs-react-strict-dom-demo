...
// https://github.com/facebook/react-strict-dom/blob/959722beff35c297f3bc0295e4d72a27cbd88093/apps/examples/src/components/App.js
/**
...
function Shell(): React.ReactNode {
  ...
  const [backgroundColor, setBackgroundColor] = React.useState(BGCOLOR_INACTIVE)
        ...
        <ExampleBlock title="CSS Layout">
          ...
          <html.div>
            ...
            <html.div
              style={[
                styles.square,
                // @ts-expect-error This is not official supported but is included in the Example
